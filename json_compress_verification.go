...
func main() {
	log.Fatal(http.ListenAndServe(":8091", handlerVerificacion(handler)))
}

func handlerVerificacion(hand http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		logActions := strings.Contains(r.Header.Get("X-Allow-Logs"), "true")
